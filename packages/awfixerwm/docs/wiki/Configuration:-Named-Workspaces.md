...
// Open Fractal on the "chat" workspace, if it runs at awm startup.
window-rule {
...
When editing the config while awm is running, newly declared named workspaces will appear at the very top of a monitor.
