awm's documentation files are found in `docs/wiki/` and should be viewable and browsable in at least three systems:

- The GitHub repo's markdown file preview
- [The GitHub repo's wiki](https://github.com/awfixerwm/awm/wiki)
- [The documentation site](https://awfixerwm.github.io/awm/)
...
The documentation site should now be available on http://127.0.0.1:8000/awm/
