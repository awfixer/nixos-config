...
Floating windows in awm always show on top of the tiled windows.
...
You can precisely position a floating window with a command like `awm msg action move-floating-window -x 100 -y 200`.
