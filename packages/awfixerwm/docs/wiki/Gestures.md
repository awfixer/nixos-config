...
There are several gestures in awm.
...
This works with both window-initiated resizes (when using client-side decorations), and awm-initiated <kbd>Mod</kbd> + right click resizes.
