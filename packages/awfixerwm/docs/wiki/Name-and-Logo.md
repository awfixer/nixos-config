The name "awm" is canonically written in lower-case, but feel free to capitalize it if you'd like, especially at the start of sentences where the grammatical rules require it.
...
|        | full-sized                     | icon                           |
|--------|:------------------------------:|:------------------------------:|
| normal | ![](./logo/awm-logo.svg)      | ![](./logo/awm-icon.svg)      |
| simple | ![](./logo/awm-logo-smol.svg) | ![](./logo/awm-icon-smol.svg) |

The logo is intentionally recolorable.
In fact, there's [a webpage](https://awmlogo.raurutuchr.ink) that lets you quickly adjust the color and download an SVG.
