...
impl Animation {
    ...
    pub fn replace_config(&mut self, config: awm_config::Animation) {
        ...
        match config.kind {
            awm_config::animations::Kind::Spring(p) => {
            ...
            awm_config::animations::Kind::Easing(p) => {
                *self = Self::ease(
                    self.clock.clone(),
                    self.from,
                    self.to,
...
impl From<awm_config::animations::Curve> for Curve {
    fn from(value: awm_config::animations::Curve) -> Self {
        match value {
            awm_config::animations::Curve::Linear => Curve::Linear,
            awm_config::animations::Curve::EaseOutQuad => Curve::EaseOutQuad,
            awm_config::animations::Curve::EaseOutCubic => Curve::EaseOutCubic,
            awm_config::animations::Curve::EaseOutExpo => Curve::EaseOutExpo,
            awm_config::animations::Curve::CubicBezier(x1, y1, x2, y2) => {
