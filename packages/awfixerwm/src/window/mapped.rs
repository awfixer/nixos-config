...
use awm_config::{Color, Config, CornerRadius, GradientInterpolation, WindowRule};
...
impl MappedId {
    ...
    /// This is within the 32-character limit, and is nice because it matches up with how `awm msg`
...
impl Mapped {
    ...
    pub fn render_for_screen_cast<R: AWMRenderer>(
        &self,
        renderer: &mut R,
        scale: Scale<f64>,
    ...
    fn render_popups<R: AWMRenderer>(
        ...
        for (popup, offset) in PopupManager::popups_for_surface(surface) {
            let popup_rules = match popup {
                ...
                PopupKind::InputMethod(_) => awm_config::ResolvedPopupsRules::default(),
            };
