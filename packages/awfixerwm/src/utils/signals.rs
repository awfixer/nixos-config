...
//! never intended to spawn awm with a nonempty sigmask. It indicates a bug in whoever spawned us,
...
mod platform {
    ...
    pub fn listen(handle: &calloop::LoopHandle<crate::awm::State>) {
