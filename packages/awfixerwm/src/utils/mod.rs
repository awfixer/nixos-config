...
pub fn version() -> String {
    if let Some(v) = option_env!("AWM_BUILD_VERSION_STRING") {
    ...
    let commit =
        option_env!("AWM_BUILD_COMMIT").unwrap_or(git_version!(fallback = "unknown commit"));
...
pub fn logical_output(output: &Output) -> awm_ipc::LogicalOutput {
    let loc = output.current_location();
    let size = output_size(output);
    let transform = match output.current_transform() {
        Transform::Normal => awm_ipc::Transform::Normal,
        Transform::_90 => awm_ipc::Transform::_90,
        Transform::_180 => awm_ipc::Transform::_180,
        Transform::_270 => awm_ipc::Transform::_270,
        Transform::Flipped => awm_ipc::Transform::Flipped,
        Transform::Flipped90 => awm_ipc::Transform::Flipped90,
        Transform::Flipped180 => awm_ipc::Transform::Flipped180,
        Transform::Flipped270 => awm_ipc::Transform::Flipped270,
    };
    awm_ipc::LogicalOutput {
        x: loc.x,
        y: loc.y,
        width: size.w as u32,
...
pub fn ipc_transform_to_smithay(transform: awm_ipc::Transform) -> Transform {
    match transform {
        awm_ipc::Transform::Normal => Transform::Normal,
        awm_ipc::Transform::_90 => Transform::_90,
        awm_ipc::Transform::_180 => Transform::_180,
        awm_ipc::Transform::_270 => Transform::_270,
        awm_ipc::Transform::Flipped => Transform::Flipped,
        awm_ipc::Transform::Flipped90 => Transform::Flipped90,
        awm_ipc::Transform::Flipped180 => Transform::Flipped180,
        awm_ipc::Transform::Flipped270 => Transform::Flipped270,
    }
}
