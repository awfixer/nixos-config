...
use super::renderer::AWMRenderer;
...
impl Shaders {
    fn compile(renderer: &mut GlesRenderer) -> Self {
        ...
        let clipped_surface = renderer
            .compile_custom_texture_shader(
                ...
                &[
                    UniformName::new("awm_scale", UniformType::_1f),
                    UniformName::new("geo_size", UniformType::_2f),
                    UniformName::new("corner_radius", UniformType::_4f),
                    UniformName::new("input_to_geo", UniformType::Matrix3x3),
                ],
    ...
    pub fn get(renderer: &mut impl AWMRenderer) -> &Self {
...
fn compile_resize_program(
    ...
    ShaderProgram::compile(
        ...
        &program,
        &[
            UniformName::new("awm_input_to_curr_geo", UniformType::Matrix3x3),
            UniformName::new("awm_curr_geo_to_prev_geo", UniformType::Matrix3x3),
            UniformName::new("awm_curr_geo_to_next_geo", UniformType::Matrix3x3),
            UniformName::new("awm_curr_geo_size", UniformType::_2f),
            UniformName::new("awm_geo_to_tex_prev", UniformType::Matrix3x3),
            UniformName::new("awm_geo_to_tex_next", UniformType::Matrix3x3),
            UniformName::new("awm_progress", UniformType::_1f),
            UniformName::new("awm_clamped_progress", UniformType::_1f),
            UniformName::new("awm_corner_radius", UniformType::_4f),
            UniformName::new("awm_clip_to_geometry", UniformType::_1f),
        ],
        &["awm_tex_prev", "awm_tex_next"],
    )
}
...
fn compile_close_program(
    ...
    ShaderProgram::compile(
        ...
        &program,
        &[
            UniformName::new("awm_input_to_geo", UniformType::Matrix3x3),
            UniformName::new("awm_geo_size", UniformType::_2f),
            UniformName::new("awm_geo_to_tex", UniformType::Matrix3x3),
            UniformName::new("awm_progress", UniformType::_1f),
            UniformName::new("awm_clamped_progress", UniformType::_1f),
            UniformName::new("awm_random_seed", UniformType::_1f),
        ],
        &["awm_tex"],
    )
}
