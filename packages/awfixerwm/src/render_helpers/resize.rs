...
use super::renderer::{AsGlesFrame, AWMRenderer};
...
impl ResizeRenderElement {
    ...
    pub fn new(
        ...
        Self(
            ShaderRenderElement::new(
                ...
                result_alpha,
                Rc::new([
                    mat3_uniform("awm_input_to_curr_geo", input_to_curr_geo),
                    mat3_uniform("awm_curr_geo_to_prev_geo", curr_geo_to_prev_geo),
                    mat3_uniform("awm_curr_geo_to_next_geo", curr_geo_to_next_geo),
                    Uniform::new("awm_curr_geo_size", curr_geo_size.to_array()),
                    mat3_uniform("awm_geo_to_tex_prev", geo_to_tex_prev),
                    mat3_uniform("awm_geo_to_tex_next", geo_to_tex_next),
                    Uniform::new("awm_progress", progress),
                    Uniform::new("awm_clamped_progress", clamped_progress),
                    Uniform::new("awm_corner_radius", <[f32; 4]>::from(corner_radius)),
                    Uniform::new("awm_clip_to_geometry", clip_to_geometry),
                ]),
                HashMap::from([
                    (String::from("awm_tex_prev"), texture_prev),
                    (String::from("awm_tex_next"), texture_next),
                ]),
                Kind::Unspecified,
            )
    ...
    pub fn has_shader(renderer: &mut impl AWMRenderer) -> bool {
