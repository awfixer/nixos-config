...
use awm_config::{CenterFocusedColumn, PresetSize, Struts};
use awm_ipc::{ColumnDisplay, SizeChange, WindowLayout};
...
pub struct ScrollingSpace<W: LayoutElement> {
    ...
    ///
    /// Takes into account layer-shell exclusive zones and awm struts.
...
impl<W: LayoutElement> ScrollingSpace<W> {
    ...
    fn activate_column_with_anim_config(&mut self, idx: usize, config: awm_config::Animation) {
    ...
    pub fn add_tile(
        ...
        width: ColumnWidth,
        is_full_width: bool,
        anim: Option<awm_config::Animation>,
    ) {
    ...
    pub fn add_column(
        ...
        mut column: Column<W>,
        activate: bool,
        anim_config: Option<awm_config::Animation>,
    ) {
...
impl ViewGesture {
    fn animate_from(&mut self, from: f64, clock: Clock, config: awm_config::Animation) {
...
fn compute_toplevel_bounds(
    border_config: awm_config::Border,
