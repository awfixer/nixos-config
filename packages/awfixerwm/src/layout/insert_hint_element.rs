...
impl InsertHintElement {
    pub fn new(config: awm_config::InsertHint) -> Self {
        Self {
            inner: FocusRing::new(awm_config::FocusRing {
                off: config.off,
                width: 0.,
    ...
    pub fn update_config(&mut self, config: awm_config::InsertHint) {
        self.inner.update_config(awm_config::FocusRing {
            off: config.off,
            width: 0.,
            active_color: config.color,
            inactive_color: config.color,
