//! Window layout logic.
//!
//! AWM implements scrollable tiling with dynamic workspaces. The scrollable tiling is mostly
...
//!
//! Where possible, awm tries to follow these principles with regards to outputs:
//!
...
use awm_config::utils::MergeWith as _;
use awm_config::{
    Config, CornerRadius, LayoutPart, PresetSize, Workspace as WorkspaceConfig, WorkspaceReference,
};
use awm_ipc::{ColumnDisplay, PositionChange, SizeChange, WindowLayout};
...
pub trait LayoutElement {
    ...
    fn update_config(&mut self, blur_config: awm_config::Blur) {
        let _ = blur_config;
    }
    ...
    fn render_normal<R: AWMRenderer>(
        &self,
        ctx: RenderCtx<R>,
        location: Point<f64, Logical>,
        scale: Scale<f64>,
    ...
    fn render_popups<R: AWMRenderer>(
        &self,
        ctx: RenderCtx<R>,
        location: Point<f64, Logical>,
        scale: Scale<f64>,
...
pub struct Options {
    pub layout: awm_config::Layout,
    pub animations: awm_config::Animations,
    pub gestures: awm_config::Gestures,
    pub overview: awm_config::Overview,
    pub blur: awm_config::Blur,
    // Debug flags.
...
struct InteractiveMoveData<W: LayoutElement> {
    ...
    pub(self) output_config: Option<awm_config::LayoutPart>,
    ...
    pub(self) workspace_config: Option<(WorkspaceId, awm_config::LayoutPart)>,
}
...
impl Options {
    ...
    fn with_merged_layout(mut self, part: Option<&awm_config::LayoutPart>) -> Self {
...
impl<W: LayoutElement> Layout<W> {
    ...
    pub fn render_interactive_move_for_output<R: AWMRenderer>(
        &self,
        ctx: RenderCtx<R>,
        output: &Output,
