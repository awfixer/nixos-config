...
impl<W: LayoutElement> Workspace<W> {
    ...
    pub fn update_layout_config(&mut self, layout_config: Option<awm_config::LayoutPart>) {
    ...
    pub fn render_scrolling<R: AWMRenderer>(
        &self,
        ctx: RenderCtx<R>,
        xray_pos: XrayPos,
        focus_ring: bool,
    ...
    pub fn render_floating<R: AWMRenderer>(
        &self,
        ctx: RenderCtx<R>,
        xray_pos: XrayPos,
        focus_ring: bool,
    ...
    pub fn render_shadow<R: AWMRenderer>(
        &self,
        renderer: &mut R,
...
fn compute_workspace_shadow_config(
    config: awm_config::WorkspaceShadow,
    view_size: Size<f64, Logical>,
) -> awm_config::Shadow {
    ...
    let mut config = awm_config::Shadow::from(config);
