    ...
    pub fn render(
            ...
            .is_some()
        {
            ...
            return ShaderRenderElement::new(
                ...
                1.,
                Rc::new([
                    mat3_uniform("awm_input_to_geo", input_to_geo),
                    Uniform::new("awm_geo_size", geo_size.to_array()),
                    mat3_uniform("awm_geo_to_tex", geo_to_tex),
                    Uniform::new("awm_progress", progress as f32),
                    Uniform::new("awm_clamped_progress", clamped_progress as f32),
                    Uniform::new("awm_random_seed", self.random_seed),
                ]),
                HashMap::from([(String::from("awm_tex"), buffer.texture().clone())]),
                Kind::Unspecified,
            )
