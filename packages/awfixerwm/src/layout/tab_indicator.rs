...
use awm_config::{CornerRadius, Gradient, GradientRelativeTo, TabIndicatorPosition};
...
pub struct TabIndicator {
    ...
    config: awm_config::TabIndicator,
}
...
impl TabIndicator {
    pub fn new(config: awm_config::TabIndicator) -> Self {
        Self {
            shader_locs: Vec::new(),
            shaders: Vec::new(),
            open_anim: None,
    ...
    pub fn update_config(&mut self, config: awm_config::TabIndicator) {
        self.config = config;
    }
    ...
    pub fn start_open_animation(&mut self, clock: Clock, config: awm_config::Animation) {
    ...
    pub fn config(&self) -> awm_config::TabIndicator {
        self.config
    }
}
