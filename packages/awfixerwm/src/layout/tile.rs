...
use awm_config::{Color, CornerRadius, GradientInterpolation};
use awm_ipc::WindowLayout;
...
impl<W: LayoutElement> Tile<W> {
    ...
    pub fn animate_move_x_from_with_config(&mut self, from: f64, config: awm_config::Animation) {
    ...
    pub fn animate_move_y_from_with_config(&mut self, from: f64, config: awm_config::Animation) {
    ...
    pub fn animate_alpha(&mut self, from: f64, to: f64, config: awm_config::Animation) {
