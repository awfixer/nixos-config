...
use awm_config::{CornerRadius, LayoutPart};
...
pub struct Monitor<W: LayoutElement> {
    ...
    layout_config: Option<awm_config::LayoutPart>,
}
...
impl<W: LayoutElement> Monitor<W> {
    ...
    pub fn activate_workspace_with_anim_config(
        &mut self,
        idx: usize,
        config: Option<awm_config::Animation>,
    ) {
    ...
    pub fn update_layout_config(&mut self, layout_config: Option<awm_config::LayoutPart>) -> bool {
    ...
    pub fn render_insert_hint_between_workspaces<R: AWMRenderer>(
        &self,
        renderer: &mut R,
    ...
    pub fn render_workspaces<R: AWMRenderer>(
        &self,
        mut ctx: RenderCtx<R>,
        focus_ring: bool,
        push: &mut dyn FnMut(MonitorRenderElement<R>),
    ...
    pub fn render_workspace_shadows<R: AWMRenderer>(
        &self,
        renderer: &mut R,
        push: &mut dyn FnMut(MonitorRenderElement<R>),
    ) {
    ...
    pub fn layout_config(&self) -> Option<&awm_config::LayoutPart> {
