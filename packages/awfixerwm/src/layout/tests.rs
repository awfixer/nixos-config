...
use awm_config::utils::Flag;
use awm_config::workspace::WorkspaceName;
use awm_config::{
...
enum Op {
    ...
    AddScaledOutput {
        ...
        layout_config: Option<Box<awm_config::LayoutPart>>,
    },
    ...
    UpdateConfig {
        ...
        layout_config: Box<awm_config::LayoutPart>,
    },
}
        ...
        match self {
            ...
            Op::AddNamedWorkspace {
                ...
                layout.ensure_named_workspace(&WorkspaceConfig {
                    ...
                    layout: layout_config.map(|x| awm_config::WorkspaceLayoutPart(*x)),
                });
            }
            ...
            Op::UpdateConfig { layout_config } => {
                let options = Options {
                    layout: awm_config::Layout::from_part(&layout_config),
                    ..Default::default()
                };
...
fn interactive_move_from_workspace_with_layout_config() {
    let ops = [
        Op::AddNamedWorkspace {
            ws_name: 1,
            output_name: Some(2),
            layout_config: Some(Box::new(awm_config::LayoutPart {
                border: Some(awm_config::BorderRule {
                    on: true,
                    ..Default::default()
                }),
                ..Default::default()
