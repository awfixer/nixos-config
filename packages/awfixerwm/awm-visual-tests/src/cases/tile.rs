...
use awm::layout::Options;
use awm::render_helpers::xray::XrayPos;
use awm::render_helpers::{RenderCtx, RenderTarget};
use awm_config::Color;
...
pub struct Tile {
    window: TestWindow,
    tile: awm::layout::tile::Tile<TestWindow>,
}
...
impl Tile {
    ...
    pub fn with_window(args: Args, window: TestWindow) -> Self {
        ...
        let mut tile = awm::layout::tile::Tile::new(
            window.clone(),
            size.to_f64(),
            1.,
            clock,
