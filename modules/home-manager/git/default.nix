# Git Configuration
# Complete Git setup with delta diff viewer, GPG signing, and 1Password integration
...
with lib;
{
  ...
  home.packages = [ 
    pkgs.git-crypt    # Transparent file encryption in Git repositories - https://github.com/AGWA/git-crypt
  ];
