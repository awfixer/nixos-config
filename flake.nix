      ...
      devShells = lib.genAttrs systems (system: {
        default = (pkgsFor system).mkShell {
          ...
          nativeBuildInputs = with (pkgsFor system); [
            ...
            statix # Nix linter - https://github.com/nerdypepper/statix
            pre-commit # Pre-commit hooks framework - https://pre-commit.com/
          ];
        };
      });

      # Flake checks for CI/CD and validation
      # These checks ensure code quality and configuration validity
      # Flake checks docs: https://nixos.org/manual/nix/stable/command-ref/new-cli/nix3-flake-check.html
      checks = lib.genAttrs systems (system:
        ...
        in
        {
          ...
          docs-links = pkgs.runCommand "check-docs-links" { } ''
            # Check that all existing docs files are properly structured
